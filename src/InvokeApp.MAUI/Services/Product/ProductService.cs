...
namespace InvokeApp.MAUI.Services.Product
{
    public class ProductService : IProductService
    {
        ...
        public List<ProductDto> GetProducts()
        {
            ...
            {
                new ProductDto(){ImageUrl = "https://images.journeys.com/images/products/1_268755_ZM_THERO.JPG" , Id = 2},
                new ProductDto(){ImageUrl = "https://pc-1.ru/pic/big/183501.jpg" , Id = 1}
            };
        ...
        public List<ProductSellingDto> GetProductSelling()
        {
            ...
            {
                new ProductSellingDto(){Id = 2, ImageUrl = "https://i.ebayimg.com/00/s/MTIwMFgxNjAw/z/CJoAAOSwcCxklLOU/$_57.JPG?set_id=880000500F",Name = "Pioneer XDJ-RR", Price = 37000, Sold = true},
                new ProductSellingDto(){Id = 1, ImageUrl = "https://i.ebayimg.com/images/g/U90AAOSw8pRjpi8s/s-l960.jpg", Name = "Puma GV мужские крассовки, белое золото", Price = 10000, Sold = false}
            };
        }
    }
}
